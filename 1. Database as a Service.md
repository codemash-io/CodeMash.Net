...
CRUD operations (Async supported as well), Batching, Error Handling, Backups, Pagination, Caching, Database Index Management, Dynamic Schema Builder and Validation. More about database management you can find at  <a target="_blank" href="http://codemash.io/documentation/db/mongodb">CodeMash documentation.</a>
