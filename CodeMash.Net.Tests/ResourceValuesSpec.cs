    ...
    public class ResourceValuesSpec
    {
        ...
        public class When_get_resource_values_by_project_id_and_language_id
        {
            ...
            Because of = () =>
            {
                ...
                var result = CodeMash.GetEntity<Project>("Projects", Projects.First().Id, filter);
        ...
        public class When_get_resource_values_by_project_id
        {
            ...
            Because of = () =>
            {
                var result = CodeMash.GetEntity<Project>("Projects", Projects.First().Id, null, new[] { "Categories.Keys.Values" });
        ...
        public class D_add_new_translation_for_resource_key
        {
            ...
            Because of = () =>
            {
                ...
                ResourceValue = CodeMash.SaveEntity<ResourceValue>("Projects", resourceValue, upsertInformation);
