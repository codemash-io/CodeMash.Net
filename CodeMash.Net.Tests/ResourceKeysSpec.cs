...
namespace CodeMash.Net.Tests
{
    ...
    public class ResourceKeysSpec
    {
        ...
        public class When_get_resource_keys_by_project_category
        {
            ...
            Because of = () =>
            {
                Projects = CodeMash.GetEntities<List<Project>>("Projects");
        ...
        public class When_remove_resource_key_by_project_category
        {
            ...
            Because of = () =>
            {
                ...
                IsDeleted  = CodeMash.DeleteEntity("Projects", Projects.First().Id, filter);
        ...
        public class When_add_new_resource_key_to_project_category
        {
            ...
            Because of = () =>
            {
                ...
                ResourceKey = CodeMash.SaveEntity<ResourceKey>("Projects", resourceKey, upsertInformation);
