...
There are several options to get in touch with your database instance. When you create an account on CodeMash, we create MongoDb database for you.

First option is see database and manage it through : <a target="_blank" href="https://cloud.codemash.io/db">CodeMash database manager.</a> Just be sure that instance is exposed and you can connect remotely. 
